<template>
	<view v-if="show" class="uni-noticebar" :style="{'background-color:':backgroundColor}" @click="onClick">
		...
		<view v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon">
			<image src="../../static/icon/tongzhi.png"></image>
		</view>
		<!-- #endif -->
		<!-- #ifndef MP-ALIPAY -->
		...
		<image v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-close" style="width: 15px;height:15px;"  src="../../static/icon/tongzhi.png"></image>
		<!-- #endif -->
