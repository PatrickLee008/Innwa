<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Module" prop="ROUTE" width="200px" align="center" />
      <el-table-column label="TARGET" prop="TARGET" width="200px" align="center" />
      <el-table-column label="Content" prop="OPERATION" align="left" />
    </el-table>
